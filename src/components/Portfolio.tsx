  ...
  const projects = [
    {
      title: 'FinTech Pro',
      category: 'Финансы',
      description: 'Мобильное приложение для управления финансами с AI-советником',
      rating: 4.8,
      downloads: '100K+'
    },
    {
      title: 'HealthTracker',
      category: 'Здоровье',
      description: 'Комплексное приложение для мониторинга здоровья и фитнеса',
      rating: 4.9,
      downloads: '250K+'
    },
    {
      ...
      <div className="max-w-[1920px] mx-auto px-20">
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl text-white mb-6">
            Наши <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C48A52] to-[#FF9E76]">достижения</span>
          </h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="relative h-64 overflow-hidden">
                <ImageWithFallback 
                  src="https://images.unsplash.com/photo-1644088379091-d574269d422f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhYnN0cmFjdCUyMHRlY2hub2xvZ3klMjBuZXR3b3JrfGVufDF8fHx8MTc2NDc0NDIxMXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                  alt={project.title}
