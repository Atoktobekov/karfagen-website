        ...
        <div className="grid grid-cols-2 gap-20 items-center">
          <div>
            ...
            <h1 className="text-7xl text-white mb-8 leading-tight">
              Разработка<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C48A52] to-[#FF9E76]">
                мобильных
              </span><br />
              приложений
            </h1>
            ...
            <div className="flex gap-6">
              <button className="group px-10 py-4 bg-gradient-to-r from-[#C48A52] to-[#FF9E76] text-white rounded-lg hover:shadow-xl hover:shadow-[#C48A52]/40 transition-all flex items-center gap-3">
                Начать проект
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="px-10 py-4 border-2 border-[#C48A52] text-[#C48A52] rounded-lg hover:bg-[#C48A52]/10 transition-all">
                Наши работы
              </button>
            </div>
